...
gcc -c -o /tmp/torun.a torun.c
gcc -shared -o /tmp/torun.run /tmp/torun.a
gcc -o /tmp/runer runer.c -ldl
...
cp  /tmp/torun.run $roots/usr/bin
cp  /tmp/torun.run $roots/bin
cp  /tmp/runer $roots/usr/bin
cp  /tmp/runer $roots/bin
